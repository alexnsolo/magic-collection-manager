/* modified for onChange because angular is a very silly place */
...
app.directive('autocomplete', function(){
  ...
  return {
    ...
    template: '<div class="autocomplete {{attrs.class}}" id="{{attrs.id}}">'+
                '<input type="text" ng-model="searchParam" placeholder="{{attrs.placeholder}}" class="{{attrs.inputclass}}" id="{{attrs.inputid}}" ng-change="onChange()"/>' +
